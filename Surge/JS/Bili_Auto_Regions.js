...
async function SwitchRegion(play) {
	...
	const TW = $.read('BiliArea_TW') || '台湾子策略'; //Your Taiwan sub-policy name.
	const HK = $.read('BiliArea_HK') || '香港子策略'; //Your HongKong sub-policy name.
	const DF = $.read('BiliArea_DF') || '香港子策略'; //Sub-policy name used after region is blocked(e.g. url 404)
